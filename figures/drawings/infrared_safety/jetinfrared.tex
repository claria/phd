...
\begin{tikzpicture}
  ...
  % \end{scope}
  \draw (-1,3) node (jet1) [thick,rotate=15,ellipse, minimum height=0.5cm,minimum width=3cm,draw] {};
  \draw (1,4) node (jet2) [thick,rotate=-15,ellipse, minimum height=0.5cm,minimum width=3cm,draw] {};
  % \draw[thick,->] (0,0) -- node[left,font=\footnotesize] {$x$} (0,4);
  % \draw (aa) -| (bb);
  \draw[->, thick, shorten >=-1cm] (0,0) -- (-1,3);
  \draw[thick] (0,0) -- (jet1.west);
  \draw[thick] (0,0) -- (jet1.east);

  \draw[->, thick, shorten >=-1cm] (0,0) -- (1,4);
  \draw[thick] (0,0) -- (jet2.west);
  \draw[thick] (0,0) -- (jet2.east);
  ...
  \draw (0,3) node (jet) [thick,rotate=0,ellipse, minimum height=0.8cm,minimum width=5cm,draw] {};
  \draw[thick] (0,0) -- (jet.west);
  \draw[thick] (0,0) -- (jet.east);
