  ...
  \begin{tikzpicture}
    ...
    \draw[thick, ->] (5,0) -- (0.3,0) node[below, midway] {$p$};
      \begin{scope}[rotate=0,transform shape]
        ...
        \node[anchor=south west,gray, rotate=90] at (-1.2,3.15) {\tiny \textsc{ECAL}};
        \node[anchor=south west,gray, rotate=90] at (-1.2,3.9) {\tiny \textsc{HCAL}};
        \node[anchor=south east,gray, rotate=40] at (-0.9,2.4) {\tiny \textsc{TRACKER}};
      ...
      % \clip (-2,0) rectangle (2,-1cm);
        ...
        % particle level
        \draw[thick] (0.00,1.2) -- (0.1, 2.9);
        \draw[gray, densely dotted] (0.1,3.1) -- (0.1, 3.9);
        \draw[thick] (0.1,1.2) arc (0:-8.3:-18cm);
        \draw[gray, densely dotted, name path=particle1] (0.1,1.2) arc (0:-13:-18cm);
        \draw[thick] (-0.1,1.2) arc (0:17:9cm);
        \draw[gray, densely dotted, name path=particle2] (-0.1,1.2) arc (0:27:9cm);

        \draw [gray,densely dashed,domain=70:110,name path=tracker1] plot ({3.8cm*cos(\x)}, {3.8cm*sin(\x)});
        \draw [gray,densely dashed,domain=70:110,name path=tracker2] plot ({3.6cm*cos(\x)}, {3.6cm*sin(\x)});
        \draw [gray,densely dashed,domain=70:110,name path=tracker3] plot ({3.45cm*cos(\x)}, {3.45cm*sin(\x)});

        \fill[black, name intersections={of=tracker1 and particle1}] (intersection-1) circle (1pt) node{};
        \fill[black, name intersections={of=tracker1 and particle2}] (intersection-1) circle (1pt) node{};
        \fill[black, name intersections={of=tracker2 and particle1}] (intersection-1) circle (1pt) node{};
        \fill[black, name intersections={of=tracker2 and particle2}] (intersection-1) circle (1pt) node{};
        \fill[black, name intersections={of=tracker3 and particle1}] (intersection-1) circle (1pt) node{};
        \fill[black, name intersections={of=tracker3 and particle2}] (intersection-1) circle (1pt) node{};
