...
\begin{document}
  \begin{tikzpicture}
    ...
    \node[anchor=south west] at (-1.3,3.5) {\small Reconstructed jet};
    \node[anchor=south west] at (-1.3,1.8) {\small Particle jet};
    \node[anchor=south west] at (-1.3,0.5) {\small Parton jet};
