...
\NLOJETPP theory prediction obtained with the NNPDF 3.0 PDF set. The measurement
and the prediction agree over many orders of magnitude of the cross section.
...
dijet events, in which the fractional proton momenta $x_1$ and $x_2$
