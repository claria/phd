...
\begin{figure}[htbp]
    ...
    \caption[Differences of pseudo-rapidity of reconstructed jets to
        particle level jets]{The difference between the pseudo-rapdity of the
...
Formula~\ref{eq:resolution}.However, the influence of the different resolution formulae
...
set systematically underestimate the data. That behaviour is well known \eg
...
\begin{figure}[htbp]
    ...
    \caption[Ratio of measured cross sections to predictions using differenct MC event
    generators]{
    Ratio of the triple-differential dijet cross sections to the theoretical
    prediction using the central value of the NNPDF 3.0 NLO PDF set for each bin in \ystar
    and \yboost respectively. The data points including statistical uncertainty are
