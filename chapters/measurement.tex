...
group at CMS is employed which identifies and rejects these events.  Moreover, a
cut is applied which removes events in which the missing transverse energy
fraction \met constitutes a large fraction of the total transverse energy
$\sum_i E_{\mathrm{T},i}$, see Fig.~\ref{fig:mc:met_fraction},
...
The jet identification criteria (jet ID) rejects noise and noise-enhanced
jets while all real jets are kept. The jet ID is not applied event-wise, but each
jet is accepted or removed from the list of valid jets. The algorithm works on
reconstructed jets using information of the clustered particles candidates. 
Following the official recommendations, the loose jet ID is used. All jets
passing the jet ID are then further processed in the analysis chain. 
...
\todo{add plot with all quantities which a cut is applied on}
...
\begin{table}[htbp]
    ...
    \caption[Jet ID criteria]{The jet ID removes noise and fake jets based on
        ...
        \textsc{JetMET} group are applied~\cite{jetid_twiki}. The loose jet ID is
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb0ys0.pdf}\hfill
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb0ys1.pdf}
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb0ys2.pdf}\hfill
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb1ys0.pdf}
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb1ys1.pdf}\hfill
    \includegraphics[width=0.45\textwidth]{figures/measurement/rap_corr_data_yb2ys0.pdf}
...
transverse momentum is calculated both using the particle-level and
reconstructed jets. The response $R$ is calculated as
