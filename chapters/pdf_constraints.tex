...
\setlength\tabcolsep{2.5pt} 
  ...
  \begin{tabular}{lrrcrc}
    ...
    HERA \& CMS data                & 1154 &    --- &  --- & 1341.54 & 1.15 \rbtrr\\
    \bottomrule
  \end{tabular}
\end{table}
...
Therefore, two different methods to evaluate the scale uncertainties were
applied. First, the simultaneous fit has been repeated for each variation of the
renormalization and factorization scale, similar as reported in
Sec.~\ref{sec:scale_uncertainties}. The scale of the HERA DIS data remained
unchanged. The envelope of the best fit \asmz values for all variations is taken
as uncertainty: $\Delta\asmz= _{-0.0016}^{+0.0026}(\mathrm{scale})$.

The second procedure is analogous to the method which was applied in previous
determinations of \asmz \eg in~\cite{CMS:2014mna,Khachatryan:2014waa}. The best PDFs are
derived for a series of fixed values of \asmz. Using the series the best fit
\asmz value is determined for each scale variation. As before, the envelope of
all variations is taken as scale uncertainty: $\Delta \asmz =
_{-0.0019}^{+0.0031}(\mathrm{scale})$. Since this uncertainty is the most
consistent to compare with previous determinations of \asmz, it is reported as
the default one. 
...
\todo{comparison results 8 tev inc. jets, 7 tev results}
