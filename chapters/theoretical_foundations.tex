...
\begin{equation*} 
    ...
    \as(\mur^2)}{\partial \mur^2} \frac{\partial X}{\partial \as(\mur^2)} \right) \stackrel{!}{=} 0 
\end{equation*}
%
...
\begin{equation*}
    ...
    \xi}{\xi} f\left(\xi, \muf^2 \right) P\left( \frac{x}{\xi} \right)
\end{equation*}
%
they can be expressed at leading order for the quark PDFs $q_i(x, \muf)$ as:
\begin{equation*}
    \frac{\partial q_i (x, \muf^2)}{\partial \ln(\muf^2)} =
    \frac{\as(\muf^2)}{2\pi}\Big( \left[ q_i \otimes P_{qq}
...
%
\begin{equation*}
    \frac{\partial g (x, \muf^2)}{\partial \ln(\muf^2)} = \frac{\as(\muf^2)}{2\pi}\left(\left[\sum_i  q_i \otimes P_{gq}
...
\subsection{Generalized \texorpdfstring{\kt}{kt} Jet Algorithms}
