...
However by explicitly binning the measurement in the leading and second jet as
...
not guaranteed that all divergences are cancelled. As a consequence the
...
produces correlations between phasespace regions far off in rapidity and unneccesarily
...
\todo{dijet bild mit boost im cm und lab frame}
...
The triple-differential cross sections are measured as a function of the average
...
scale choices as it is neccessary for the calculation of PDF and scale
uncertainties.
